...
#Step 1.  Iport the tximport data, txiv3a, which was complied by Tony who has the salmon quant files.
#tx2geneV3a was used in the txiport and is based off of a list of transcripts does not contain any transcripts that didn't annotate to a vertebrate.

#upload DGElist generated by tony
load("/Users/james.cameron/Desktop/R projects/2018_Marrowstone_Herring-RNAseq/MHEE/MHEE_txiV3a.csv")
...
#extract experimental conditionsl from names
...
bb.key <- read.csv("/Users/james.cameron/Desktop/R projects/2018 Marrowstone Body purden NMDS/BodyBurden_Key.csv")
bb.key <- bb.key [ , -1]
...
#--------------------------------------------------------------------------------------------------------
#add plate from key
#plate.key <- read.csv("/Users/james.cameron/Desktop/R projects/2018_Marrowstone_Herring-RNAseq/2018_MHEE_samples_by_plate/2018_MHEE_Plates.csv", header = T, na.strings = c("", NA))
#plate.key <- plate.key[,2:10]

plate.rep <- read.csv("/Users/james.cameron/Desktop/R projects/2018_Marrowstone_Herring-RNAseq/2018_MHEE_samples_by_plate/reps_per_plate.csv", header = T, na.strings = c("", NA))
...
save(MHEE.DGEList, file = "/Users/james.cameron/Desktop/R projects/2018_Marrowstone_Herring-RNAseq/MHEE/MHEE_DGElist3b.RDS")
